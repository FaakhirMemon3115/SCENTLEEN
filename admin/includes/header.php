...
<head>
    ...
    <style>
        body { background-color: #f4f6f9; font-family: 'Inter', sans-serif; display: flex; overflow-x: hidden; }
        .sidebar { width: 250px; background: #2D2D2D; color: #fff; min-height: 100vh; position: fixed; left: 0; top: 0; padding: 20px 0; z-index: 1000; transition: transform 0.3s ease; }
        .sidebar a { display: block; color: #ccc; padding: 15px 25px; transition: 0.3s; text-decoration: none; }
        .sidebar a:hover, .sidebar a.active { background: #1a1a1a; color: var(--gold-color); border-left: 4px solid var(--gold-color); }
        
        .main-content { margin-left: 250px; width: calc(100% - 250px); padding: 30px; transition: margin 0.3s ease, width 0.3s ease; }
        ...
        .admin-toggle-btn { display: none; background: none; border: none; font-size: 1.5rem; cursor: pointer; color: #333; }
        ...
        @media (max-width: 767px) {
            ...
            .admin-header h2 { font-size: 1.2rem !important; }
            .card { padding: 15px; }
        }
    </style>
</head>
...
<aside class="sidebar" id="adminSidebar">
    ...
    <nav>
        ...
        <a href="customers.php"><i class="fas fa-users" style="width: 25px;"></i> Customers</a>
        <a href="categories.php"><i class="fas fa-tags" style="width: 25px;"></i> Categories</a>
        <a href="coupons.php"><i class="fas fa-ticket-alt" style="width: 25px;"></i> Coupons</a>
...
<div class="main-content">
    <header class="admin-header">
        <div style="display: flex; align-items: center; gap: 15px;">
            <button class="admin-toggle-btn" onclick="toggleAdminSidebar()"><i class="fas fa-bars"></i></button>
            <h2 style="font-size: 1.5rem; font-weight: 500;">Dashboard</h2>
        </div>
        <div style="display: flex; align-items: center; gap: 20px;">
            <div style="position: relative; display: none;"> <!-- Hidden bell on mobile for space -->
            ...
            <div style="display: flex; align-items: center; gap: 10px;">
                ...
                <span style="font-size: 0.9rem; font-weight: 500;" class="d-none-sm"><?php echo htmlspecialchars($_SESSION['user_name'] ?? 'Admin'); ?></span>
            </div>
            <a href="../logout.php" style="color: #e74c3c;" title="Logout"><i class="fas fa-sign-out-alt"></i></a>
        </div>
    </header>
