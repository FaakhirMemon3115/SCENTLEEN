    ...
    <div style="background: #fff; padding: 50px; border-radius: 15px; box-shadow: 0 10px 40px rgba(0,0,0,0.05); width: 100%; max-width: 500px; margin: 40px 20px;">
        ...
        <form method="POST" action="">
            <div style="margin-bottom: 20px;">
                ...
                <input type="email" name="email" required style="width: 100%; padding: 15px; border: 1px solid #ddd; border-radius: 5px; outline: none; font-family: var(--font-body); transition: border-color 0.3s;" onfocus="this.style.borderColor='var(--gold-color)'" onblur="this.style.borderColor='#ddd'">
            </div>
            ...
            <div style="margin-bottom: 20px;">
                ...
                <input type="password" name="password" required style="width: 100%; padding: 15px; border: 1px solid #ddd; border-radius: 5px; outline: none; font-family: var(--font-body); transition: border-color 0.3s;" onfocus="this.style.borderColor='var(--gold-color)'" onblur="this.style.borderColor='#ddd'">
            </div>

            <label style="display: flex; align-items: center; gap: 10px; margin-bottom: 30px; font-size: 0.9rem; color: #666; cursor: pointer;">
                <input type="checkbox" style="accent-color: var(--text-color); width: 16px; height: 16px;"> Remember me
            </label>

            <button type="submit" class="btn-primary" style="width: 100%; font-size: 1.1rem; padding: 15px;">Sign In</button>
        </form>

        <div style="text-align: center; margin-top: 30px; font-size: 0.9rem; color: #666;">
            Don't have an account? <a href="register.php" style="color: var(--gold-color); font-weight: 600;">Register Here</a>
        </div>
    </div>
